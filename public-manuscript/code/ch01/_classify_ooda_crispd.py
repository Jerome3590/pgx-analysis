...
Also writes public-code-companion outputs:
  outputs/ch01/ooda_crisp_taxonomy.csv    – per-article mapping
  outputs/ch01/ooda_crisp_summary.md      – counts + hierarchy
  outputs/ch01/OODA_CRISP_MAP.md          – review-ready reference

Usage:
  python code/ch01/_classify_ooda_crispd.py
  python code/ch01/_classify_ooda_crispd.py --dry-run
"""
...
TAX_CSV       = OUTPUT_DIR / "ooda_crisp_taxonomy.csv"
SUMMARY_MD    = OUTPUT_DIR / "ooda_crisp_summary.md"
MAP_MD        = OUTPUT_DIR / "OODA_CRISP_MAP.md"
