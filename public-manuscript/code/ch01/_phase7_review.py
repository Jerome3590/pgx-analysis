...
Scores each article in articles_screened.csv against manuscript research
topics using:
  1. pytextrank key phrases from full text (abstract + body) via inputs/ch01/scholar_json/
...
Usage:
  python code/ch01/_phase7_review.py --dry-run
  python code/ch01/_phase7_review.py --threshold 0.15 --write
"""
...
SCREENED_CSV  = OUTPUT_DIR / "articles_screened.csv"
