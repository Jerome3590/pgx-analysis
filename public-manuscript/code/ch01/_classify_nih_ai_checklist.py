...
Also writes public-code-companion outputs:
  outputs/ch01/nih_ai_checklist_tags.csv    – per-article detail
  outputs/ch01/nih_ai_checklist_summary.md  – domain coverage summary
  outputs/ch01/NIH_AI_CHECKLIST_MAP.md      – review-ready reference

Usage:
  python code/ch01/_classify_nih_ai_checklist.py
  python code/ch01/_classify_nih_ai_checklist.py --dry-run
  python code/ch01/_classify_nih_ai_checklist.py --min-score 3
"""
...
TAGS_CSV      = OUTPUT_DIR / "nih_ai_checklist_tags.csv"
SUMMARY_MD    = OUTPUT_DIR / "nih_ai_checklist_summary.md"
MAP_MD        = OUTPUT_DIR / "NIH_AI_CHECKLIST_MAP.md"
