...
Run from the public code companion root:
  python code/ch01/generate_wordclouds.py
"""
...
SCREENED_CSV = ROOT / "inputs" / "ch01" / "articles_screened.csv"
OUT_DIR      = ROOT / "outputs" / "ch01" / "wordclouds"
...
def main():
    ...
    print("\nGenerated public-code-companion word-cloud assets.")
