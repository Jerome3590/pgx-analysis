...
> **Verified 2026-07-03** against S3 pipeline logs and the Athena `APCD` workgroup (account `535362115856`). These are the **final matched analytic cohort** patient counts used for modeling (5:1 controls per case) — distinct from the raw event-workload sizes in *Performance Metrics* below.
