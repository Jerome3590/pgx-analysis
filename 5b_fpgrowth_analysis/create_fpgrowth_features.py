...
def create_all_fpgrowth_features(
    ...
    # FP-Growth output directory (step-local, under 5b_fpgrowth_analysis)
    fpgrowth_output_dir = (
        project_root / "5b_fpgrowth_analysis" / "outputs" / cohort_name / split_type / age_band_fname / event_year
    )
...
def main():
    ...
    if not args.output:
        ...
        feature_eng_dir = project_root / "5b_fpgrowth_analysis" / "outputs" / "feature_engineering"
