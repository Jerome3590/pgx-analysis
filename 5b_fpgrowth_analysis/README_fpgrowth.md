...
3. **Feature Aggregation**  
   `5b_fpgrowth_analysis/add_fpgrowth_features_to_model_data.py` writes final merged features to `fpgrowth_added_features_{cohort}_{age_band}.csv`, ready to be joined with other feature blocks (BupaR, DTW, PGx) in the final model.
