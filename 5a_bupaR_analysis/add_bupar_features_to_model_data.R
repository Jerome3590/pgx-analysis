...
bupar_output_dir <- file.path(project_root, "5a_bupaR_analysis", "outputs",
...
sequence_features_csv <- file.path(project_root, "5a_bupaR_analysis", "outputs",
                                   "feature_engineering",
...
out_dir <- file.path(project_root, "5a_bupaR_analysis", "outputs", "feature_engineering")
