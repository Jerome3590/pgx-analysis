...
| **Feature Importance** | 3a_feature_importance/{cohort}/plots/, 3a_feature_importance/plots/ | GET /visualizations/feature_importance?cohort= | visualizations/feature_importance/{cohort}/aggregated_fi_heatmap.png\|.json, visualizations/feature_importance/combined_cohorts_*.png | Step 6 |
...
| **BupaR Process Mining** | 10_risk_dashboard/visualizations/bupar/{cohort}/{age_band_fname}/plots/ | GET /visualizations/bupar, /bupar/activity_frequency, /bupar/html | visualizations/bupar/{cohort}/{age_band}/plots/ | 4_dashboard_visuals (BupaR) |
| **DTW Trajectories** | 10_risk_dashboard/visualizations/dtw/{cohort}/{age_band_fname}/ (chart_data.json, sequence_heatmap.json, plots/) | GET /visualizations/dtw?cohort=&age_band= | visualizations/dtw/{cohort}/{age_band}/chart_data.json, sequence_heatmap.json, plots/ | 4_dashboard_visuals (DTW) |
| **FP-Growth Patterns** | 10_risk_dashboard/visualizations/fpgrowth/{cohort}/{age_band_fname}/plots/, .../data/ (itemsets JSON) | GET /visualizations/fpgrowth, /fpgrowth/network_html | visualizations/fpgrowth/{cohort}/{age_band}/plots/, .../data/*.json | 4_dashboard_visuals (FP-Growth) |
