...
if str(PROJECT_ROOT / "5c_pgx_analysis") not in sys.path:
    sys.path.insert(0, str(PROJECT_ROOT / "5c_pgx_analysis"))
...
def load_cpic_drug_list_from_file() -> List[Dict]:
    ...
    """
    drug_list_path = PROJECT_ROOT / "5c_pgx_analysis" / "data" / "cpic_drug_list.json"
    cpic_excel_path = PROJECT_ROOT / "5c_pgx_analysis" / "cpic" / "cpic_gene-drug_pairs.xlsx"
    cpic_pairs_path = PROJECT_ROOT / "5c_pgx_analysis" / "data" / "cpicPairs.csv"
...
def main():
    ...
    if not args.output:
        args.output = (
            PROJECT_ROOT / "5c_pgx_analysis" / "outputs" / args.cohort /
