...
This script scans `5c_pgx_analysis/outputs/**` for:
- `*_drug_gene_mappings.csv`
- `*_allele_frequencies.csv`

and writes consolidated, de-duplicated global tables:
- `5c_pgx_analysis/outputs/global/pgx_drug_gene_mappings_global.csv`
- `5c_pgx_analysis/outputs/global/pgx_allele_frequencies_global.csv`
...
def build_global_drug_gene_mappings() -> Path:
    base_dir = PROJECT_ROOT / "5c_pgx_analysis" / "outputs"
