...
def add_pgx_features(
    ...
    # Upload to S3 gold location (organized by analysis step; legacy mirror)
    s3_path = f"s3://pgxdatalake/gold/feature_engineering/7_pgx/{cohort_name}/{age_band}/pgx_added_features_{cohort_name}_{age_band_fname}.csv"
