...
2_create_cohort/
├── create_cohort.py
├── 1_pipeline_steps.py (legacy; moved to archived/2_create_cohort/)
└── phases/
    ├── __init__.py
    ├── common.py
...
- `helpers/PIPELINE_STATE_README.md` — Checkpoint architecture
- `helpers/README_duckdb_optimization.md` — Database performance tuning
