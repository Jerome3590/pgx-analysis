...
**Script:** `create_cross_ageband_heatmap.R` (in `r_helpers/`)

**Note:** This is optional/exploratory analysis; not part of the final workflow. Kept in `docs/archived/` for reference.
...
```bash
# From 3a_feature_importance directory
