...
### ✅ Step 10: Dashboard visuals (`9_dashboard_visuals`)
- **Run by:** 4_dashboard_visuals.ipynb (see `9_dashboard_visuals/README.md`)
- **Checkpoint:** `pipeline_checkpoints/9_dashboard_visuals/{cohort}/{age_band}/checkpoint.json`
