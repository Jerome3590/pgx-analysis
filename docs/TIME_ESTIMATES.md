...
| Cohort | Age Band | Events | Step 4 | Step 5 | Step 6 | Step 7 (SHAP) | Step 8 (FFA) | Step 9 | **Total** |
|--------|----------|--------|--------|--------|--------|---------------|--------------|--------|-----------|
| **opioid_ed** | 13-24 | ~600K | 10-15 min | 10-15 min | 30-45 min | 1-1.5 hrs | 1-1.5 hrs | 10-15 min | **~4-5 hours** |
| **opioid_ed** | 25-44 | ~4.6M | 30-45 min | 20-30 min | 1-2 hrs | 2-3 hrs | 2-3 hrs | 20-30 min | **~7-10 hours** |
| **opioid_ed** | 45-54 | ~1.5M | 20-30 min | 15-20 min | 45-60 min | 1.5-2 hrs | 1.5-2 hrs | 15-20 min | **~5-7 hours** |
...
### Step 4: Model Data (Cases + Controls)
...
- **Note:** Event filtering (e.g. administrative/scheduling codes) is done in Step 1b; DTW is for dashboard visualizations only.
...
- ✅ **Step 4**: All 7 cohorts have model data outputs (may need regeneration with controls)
- ⚠️ **Step 5**: 3 cohorts have PGx features (opioid_ed: 13-24, 25-44, 45-54)
- ❌ **Steps 6, 7, 8, 9**: As needed per cohort

**Remaining work:**
- Regenerate Step 4 outputs with controls (if needed): ~2-4 hours total
- Complete Step 5 for remaining 4 cohorts: ~1-2 hours total
...
Use the checkpoint status script (if available):
```bash
