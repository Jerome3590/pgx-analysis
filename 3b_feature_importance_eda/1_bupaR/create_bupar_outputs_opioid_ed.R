...
# Path cohort for model_events: this script is for opioid_ed only. Python writes to
# 3b.../outputs/cohort_name=opioid_ed/age_band=... and syncs to gold/cohorts_model_data/cohort_name=opioid_ed/...
path_cohort <- cohort_name  # "opioid_ed"
...
# 3b.../outputs/cohort_name=opioid_ed/age_band=... and synced to gold/cohorts_model_data/cohort_name=opioid_ed/...
