...
Outputs
-------
  figures/fig_prisma_flowchart.pdf   (publication-quality PDF)
  figures/fig_prisma_flowchart.png   (1200 dpi PNG)
  scripts/prisma_counts_current.csv  (all stage counts)

Usage
-----
  python scripts/_generate_prisma.py
  python scripts/_generate_prisma.py --no-figure   # counts CSV only
"""
...
# ── Paths ─────────────────────────────────────────────────────────────────────
ROOT          = Path(".")
SCREENED      = ROOT / "data/ontology/articles_screened.csv"
SCHOLAR_JSON  = ROOT / "data/scholar_json"
SCHOLAR_PDFS  = ROOT / "data/scholar_pdfs"
FIGURES_DIR   = ROOT / "figures"
OUT_CSV       = ROOT / "scripts/prisma_counts_current.csv"

SOURCE_CSVS = [
    "data/chapter1/1.1_introduction/blackbox_cds/blackbox_cds_articles.csv",
    "data/chapter1/1.3_methodological/apcd_analysis/apcd_analysis_articles.csv",
    "data/chapter1/1.2_clinical_background/pharmacovigilance/pharmacovigilance_articles.csv",
    "data/chapter1/1.1_introduction/interpretability/interpretability_articles.csv",
    "data/chapter1/1.3_methodological/pattern_mining/fpgrowth/fpgrowth_articles.csv",
    "data/chapter1/1.3_methodological/pattern_mining/process_mining/process_mining_articles.csv",
    "data/chapter1/1.4_technical/catboost_xgboost/catboost_xgboost_articles.csv",
    "data/chapter1/1.3_methodological/pattern_mining/dtw/dtw_articles.csv",
    "data/chapter1/1.3_methodological/temporal_causality/temporal_causality_articles.csv",
    "data/chapter1/1.3_methodological/target_leakage/target_leakage_articles.csv",
    "data/chapter1/1.2_clinical_background/opioid_disorder/opioid_disorder_articles.csv",
    "data/chapter1/1.2_clinical_background/polypharmacy/polypharmacy_articles.csv",
    "data/chapter1/1.2_clinical_background/drug_interactions/drug_interactions_articles.csv",
    "data/chapter1/1.4_technical/duckdb_olap/duckdb_articles.csv",
    "data/other_chapters/pgx_models/pgx_risk_classifcation_articles.csv",
    "data/other_chapters/ehr_models/risk_model_ehr_articles.csv",
    "data/other_chapters/fhir_models/fhir_ehr_articles.csv",
]
SEARCH_LABELS = [
