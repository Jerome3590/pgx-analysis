...
Run the notebook from the project root or from `9_risk_dashboard` so that paths resolve correctly.
...
- **Metadata:** `9_risk_dashboard/outputs/metadata/`
- **Models:** `9_risk_dashboard/outputs/models/`
- **Lambda package:** `9_risk_dashboard/lambda_dir/` (or as configured in `prepare_lambda_dir.py`)
