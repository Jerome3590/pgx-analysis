...
def ensure_itemsets(
    ...
    with step_block("4_fpgrowth", "ensure_itemsets", logger=logger):
        ...
        script_path = PROJECT_ROOT / "10b_fpgrowth_dashboard_visual" / "run_single_cohort_fpgrowth.py"
...
def create_features(
    ...
    with step_block("4_fpgrowth", "create_features", logger=logger):
        ...
        script_path = PROJECT_ROOT / "10b_fpgrowth_dashboard_visual" / "create_fpgrowth_features.py"
...
def add_features_to_model_data(
    ...
    with step_block("4_fpgrowth", "add_features_to_model_data", logger=logger):
        ...
        script_path = (
            PROJECT_ROOT / "10b_fpgrowth_dashboard_visual" / "add_fpgrowth_features_to_model_data.py"
        )
...
def create_visualizations(
    ...
    with step_block("4_fpgrowth", "create_visualizations", logger=logger):
        ...
        script_path = PROJECT_ROOT / "10b_fpgrowth_dashboard_visual" / "create_plots.py"
        plots_output_dir = (
            PROJECT_ROOT
