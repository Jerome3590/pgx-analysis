...
def prepare_models(download_s3: bool = False) -> bool:
    ...
    if not success:
        error("  Run: python 9_risk_dashboard/data_preparation/prepare_models.py --all")
...
def main():
    ...
    if success:
        ...
        error("  1. Models:  python 9_risk_dashboard/data_preparation/prepare_models.py --all")
        error("             (requires 6_final_model outputs)")
        error("  2. CPIC:   python 9_risk_dashboard/data_preparation/prepare_cpic_data.py")
