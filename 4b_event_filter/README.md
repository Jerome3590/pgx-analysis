...
1. **Administrative Code Filtering**: Remove events with codes listed in `administrative_codes_lookup.json`
   ...
   - Lookup table: `4b_event_filter/administrative_codes_lookup.json`
...
### Step 4b: Event Filtering (This Step)
...
- Step 4a: `4a_model_data/` - Model data creation
